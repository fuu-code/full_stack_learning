...
app.post("/", async (req, res) => {
  try {
    ...
    console.log(activityType, numParticipants)
    const response = await axios.get(`https://bored-api.appbrewery.com/filter?type=${activityType}&participants=${numParticipants}`);
    const result = response.data;
